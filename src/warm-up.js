...
inStock = inStock * 2;
console.log('double stock', inStock)
...
inStock -= 1
console.log('decrement stock', inStock)
...
console.log('inventory', shouldOrderMore)
...
var vegetables = ['brussel sprouts', 'asparagus', 'corn', 'kale', 'broccoli']
...
// different fruits.
var fruits = ['plums', 'pineapple', 'cherries', 'apples', 'blueberries', 'pears', 'pomegranates'];
